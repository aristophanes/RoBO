...
class FreezeThawGP(BaseModel):
    ...
    def predict(self, xprime, option='asympt', conf_nr=0, from_step=None, further_steps=1, full_cov=False):
        """
    ...
    def pred_asympt(self, xprime):
        ...
        kx_star = self.kernel_hyper(self.X, self.xprime, show=False)
